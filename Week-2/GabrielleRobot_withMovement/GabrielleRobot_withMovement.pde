...
void setup(){
  ...
  moveX = 122;
  moveY = -60;//arm movement controls
...
void draw(){
  ...
  fill(222, 111, 111);
  ellipse(moveX+211,moveY+397,28,28);//heart
  ellipse(moveX+228,moveY+397,28,28);
  triangle(moveX+240,moveY+404,moveX+220,moveY+427,moveX+199,moveY+404);
  fill(236, 89, 247);
